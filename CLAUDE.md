...
- `docs/plan-astra.md`: the half-day schedule, gate criteria, cut table, storyboard.
...
- Milestone gates: `npm run snapshot -- <tag>`, Codex review, the human tags and pushes, then evidence goes in `docs/milestones.md` and the platform context doc.
